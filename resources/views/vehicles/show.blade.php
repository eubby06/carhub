			...
			<div class="full-width vehicle-description">
				...
				<div class="car-full-image one-half col-480">
					<div class="main-image">
						<a href="#">
							<img src="{{ asset('images/mercedes_full.jpg') }}" alt="Full Picture" />
							<span class="magnifying-glass">Magnifying Glass</span>
						</a>
					</div>
					<ul class="images-navigation">
						<li><a href="images/mercedes_full.jpg"><img src="{{ asset('images/mercedes_thumb_list_item.jpg') }}" alt="Thumb Car" /></a></li>
						<li><a href="images/mercedes_full1.jpg"><img src="{{ asset('images/mercedes_thumb_list_item1.jpg') }}" alt="Thumb Car" /></a></li>
						<li><a href="images/mercedes_full2.jpg"><img src="{{ asset('images/mercedes_thumb_list_item2.jpg') }}" alt="Thumb Car" /></a></li>
                        <li><a href="images/mercedes_full3.jpg"><img src="{{ asset('images/mercedes_thumb_list_item3.jpg') }}" alt="Thumb Car" /></a></li>
                        <li><a href="images/mercedes_full4.jpg"><img src="{{ asset('images/mercedes_thumb_list_item4.jpg') }}" alt="Thumb Car" /></a></li>
					</ul>
			...
			<div class="full-width grey-border-bottom">
				...
				<div class="one-half col-241 search-area">
					...
					<div class="grey-corner-box">
						<a href="#"><img src="{{ asset('images/image_ads_here.gif') }}" alt="Advertisement" /></a>
					</div>
				...
				<ul class="offer-small list-content">
					<li>
						<a href="car-details.html">
							<img src="{{ asset('images/mercedes-thumb.jpg') }}" alt="offer car" />
